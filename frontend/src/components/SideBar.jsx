...
import { Home as HomeIcon, Person as PersonIcon, Badge as BadgeIcon, PersonAdd as PersonAddIcon,  AccessTime as AccessTimeIcon, Event as EventIcon, BarChart as BarChartIcon, PieChart as PieChartIcon, Timeline as TimelineIcon, SensorDoor as SensorDoorIcon } from '@mui/icons-material';
...
const Array2 = [
  ...
  { "text": "Status", 'icon': <TimelineIcon />, "path": "/timeline" },
];
...
const SideBar = ({ open, handleDrawerClose }) => {
  ...
  align="center"
  sx={{
    fontSize: open ? 49 : 0, // Change the fontSize to 30 when open is true
    transition: "0.35s",
    fontWeight:"bold",
    color: open ? 'red' : 'inherit', // Change the color to red when open is true
  }}
>
  Seca
</Typography>
